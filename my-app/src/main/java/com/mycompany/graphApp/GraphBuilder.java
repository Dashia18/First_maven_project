...
class GraphBuilder {
     static void sparseMultigraphBuild() {
         ...
         DirectedGraph<MyVertex, MyEdge> graph = new DirectedSparseGraph<MyVertex, MyEdge>();
         ...
         MyEdge edgeC = new MyEdge("Edge-G", 1, 96);
         MyEdge edgeD = new MyEdge("Edge-D", 3, 192);
         MyEdge edgeE = new MyEdge("Edge-E", 2, 96);
         MyEdge edgeF = new MyEdge("Edge-F", 1, 96);

         graph.addEdge(edgeA, v1, v2);
         graph.addEdge(edgeB, v2, v3);
         graph.addEdge(edgeC, v3, v4);
         graph.addEdge(edgeD, v1, v5);
         graph.addEdge(edgeE, v4, v5);
         graph.addEdge(edgeF, v2, v5);
